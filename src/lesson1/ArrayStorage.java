...
public class ArrayStorage {
    ...
    public boolean delete(int index) {
        ...
        if( index >= storages.length || index < 0 ) {
            ...
            // делаем перебор елементов и копируем их в новый временный масив, если  дошли к  елементу с номером который указан в методе не выполняем никаких действий,
    ...
    // сервисный метод для проверки  количества  елеемнтов и  отображения поля Name объекта Storage
